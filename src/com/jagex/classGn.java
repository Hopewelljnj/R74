...
public class classGn {
    ...
    public static final classGn fieldA = new classGn(1, 0, "", "");
    static final classGn fieldM = new classGn(7, 5, "", "");
    static final classGn fieldB = new classGn(4, 3, "", "");
    static final classGn fieldI = new classGn(5, 2, "", "");
    static final classGn fieldL = new classGn(6, 4, "", "");
    static final classGn fieldW = new classGn(2, 6, "", "");
    static final classGn fieldV = new classGn(0, 1, "", "");
    public static final classGn fieldE = new classGn(3, -1, "", "", true, new classGn[]{fieldA, fieldV, fieldI, fieldL, fieldB});
    public final int fieldN;
    final String fieldS;


    classGn(int var1, int var2, String var3, String var4, boolean var5, classGn[] var6) {
        this.fieldN = -1388555817 * var1;
        this.fieldS = var4;
    }

    classGn(int var1, int var2, String var3, String var4) {
